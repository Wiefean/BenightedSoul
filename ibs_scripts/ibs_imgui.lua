...
MakeCharacterBar(IBS_PlayerKey.BIsaac, Language('以撒', 'Isaac'), 
{
	...
	BlueBaby = Language('解锁 "嗝屁猫砂盆"', 'For "Guppy\'s Potty"'),
	Satan = Language('解锁 "酒瓶碎片"', 'For "Bottle Shard"'),
	Lamb = Language('解锁 "赌徒之眼"', 'For "Gambler\'s Eye"'),
...
MakeCharacterBar(IBS_PlayerKey.BCBA, Language('该隐&亚伯', 'Cain & Abel'), {
	...
	Satan = Language('解锁 "左断脚"', 'For "The Left Foot"'),
...
MakeCharacterBar(IBS_PlayerKey.BJudas, Language('犹大', 'Judas'), {
	...
	Greed = Language('解锁 "备用钉子"', 'For "The Reserved Nail"'),
...
MakeCharacterBar(IBS_PlayerKey.BLost, Language('游魂', 'The Lost'), {
	...
	Greed = Language('解锁 "北落师门"', 'For "Fomalhaut"'),
...
MakeCharacterBar(IBS_PlayerKey.BKeeper, Language('店主', 'The Keeper'), {
	...
	BlueBaby = Language('解锁 "接触的G"，"增殖的G"，"潜伏的G"，"对峙的G"和"应战的G"', 'For "Contact C", "Maxx C", "Sneaky C", "Confronting C" and "Retaliating C"'),
